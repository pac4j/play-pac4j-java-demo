...
public class Application extends JavaController {
    ...
    public static Result index() throws TechnicalException {
        ...
        final String urlSaml = getRedirectAction("Saml2Client", "/?4").getLocation();
        return ok(views.html.index.render(profile, urlFacebook, urlTwitter, urlForm, urlBasicAuth, urlCas, urlSaml));
    }
